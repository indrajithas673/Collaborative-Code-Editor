      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-2xl shadow-xl dark:shadow-none border border-gray-100 dark:border-gray-800 p-8 space-y-6">
        ...
        <div className="flex flex-col items-center space-y-2 text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Join the collaborative workspace today
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md shadow-blue-500/20 transition-all flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed mt-2"
          >
